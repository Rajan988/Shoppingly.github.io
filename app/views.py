...
class ProductView(View):
	def get(self, request):
		...
		return render(request, 'app/index.html', {'topwears':topwears, 'bottomwears':bottomwears, 'mobiles':mobiles, 'laptops':laptops, 'totalitem':totalitem})
...
def topwear(request, data=None):
	...
	if data==None :
			topwears = Product.objects.filter(category='TW')
	elif data == 'TShirt' or data == 'Shirt':
	...
	return render(request, 'app/top.html', {'topwears':topwears, 'totalitem':totalitem})
